...
+ (NSArray *)photosWithTags:(NSArray *)tags uploadedSince:(NSDate *)lastUploadDate
{
	return [self photosWithTags:tags uploadedSince:lastUploadDate additionalArguments:nil];
}

+ (NSArray *)photosWithTags:(NSArray *)tags
{
	return [self photosWithTags:tags uploadedSince:nil additionalArguments:nil];
}
